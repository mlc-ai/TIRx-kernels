...
| --- | --- |
| `.agents/sketch/flashinfer/kda/recurrent_kda_decode_one_warp.md` | `tirx_kernels/flashinfer/kda_decode/b200/recurrent_kda_decode_one_warp.py` |
| `.agents/sketch/flashinfer/gdn_prefill/gdn_prefill_sm100.md` | `tirx_kernels/flashinfer/gdn_prefill/b200/gdn_prefill_sm100.py` |
