...
- label: `kineto-after-b24df1a-gpu2-schema3`
- git: tir=`ea0950ab`  tirx-kernels=`b24df1a9-dirty`  tirx-bench-ci=`-`
...
- host resource peaks: process tree=6, RSS=3.587 GiB, FDs=328
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `allgather_gemm/tp1_m8192_n24576_k4096_fp16_dynamic` | `2` | 0.059 | 0.005 | 2.541 | 0.376 | 0.000 | 5.628 | 8.550 | 0.045 | 1.230 | 7.085 | 0.003 | 0.265 |
...
|---|---:|---:|---:|
| tp1_m8192_n24576_k4096_fp16_dynamic **[FAIL]** | — | 1 | 2 |
