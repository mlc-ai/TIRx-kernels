...
"""CLI entry point: python -m tirx_kernels.bench.run [--kernel <name>] [--config <label>]"""
...
def main():
    ...
    from tirx_kernels.bench.runner import set_external_references_enabled

    set_external_references_enabled(args.with_references)

    from tirx_kernels.bench.registry import discover_kernels, load_kernel
