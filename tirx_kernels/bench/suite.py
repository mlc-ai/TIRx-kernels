...
def write_generated_workloads(workloads: list[dict], path: Path) -> Path:
    ...
    header = (
        "# Generated by bench_suite from tirx_kernels/bench/config/**/*.yaml\n"
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        "`default: true` config from tirx_kernels/bench/config/**/*.yaml)",
    )
    ap.add_argument(
        "--out-dir",
        type=Path,
    ...
    bench_path = reports_dir / "tirx_kernels.bench.md"
