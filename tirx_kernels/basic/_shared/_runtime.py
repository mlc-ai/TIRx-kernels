...
class PreparedDistributedBench:
    ...
    def run_gpu(
        ...
        *,
        ...
        from tirx_kernels.bench.runner import current_cuda_assignment
...
def _rank_entry(
    ...
    result = None
    try:
        from tirx_kernels.bench.runner import bind_cuda_assignment, validate_current_cuda_assignment
...
def _run_distributed_modules(
    ...
    *,
    ...
    from tirx_kernels.bench.runner import cuda_target, physical_cuda_uuids
