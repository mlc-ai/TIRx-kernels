...
KERNEL_META : dict
    ...
    - "category" (str): the bucket subdirectory the module lives in. Port
      buckets are named for their upstream project; ``basic`` holds reusable
      native primitives, and ``curated`` holds directly implemented TIRx
      kernels admitted through portfolio-wide validation.
