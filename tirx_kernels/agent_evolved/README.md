...
| [`agent_evolved_alphamoe_fp8_blockscale_qwen3next`](alphamoe_fp8_blockscale_qwen3next.py) | `m128_official` | GB200 | CUPTI | 59.984 | FlashInfer `trtllm_fp8_block_scale_routed_moe` | 112.537 | 1.8761x | `alphamoe_m128_e512_topk10_k2048_i128_fp8-20260915-183022` `split-grid-self-first` on official row `alphamoe-qwen3-next-tp4-m128-e512-top10-k2048-i128-fp8`; same-run candidate/reference pair from the locked evaluation harness (CUDA-graph-captured baseline), verdict STABLE over 22 checks, max_rms_ratio 9.038e-05; five official runs 59.984/60.040/60.096/60.368/60.471 us |
