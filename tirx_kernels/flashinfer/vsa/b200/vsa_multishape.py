...
speedup on that shape (1.426x vs 1.411x through the optimization harness, inside
run-to-run noise).
...
2026-09-11 multi-shape VSA optimization run, which generalized the merged
