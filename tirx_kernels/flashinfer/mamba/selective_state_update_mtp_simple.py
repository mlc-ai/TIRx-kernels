...
def get_kernel(**kwargs: Any):
    ...
    def selective_state_update_mtp_simple(
        ...
        def prepare_active_sequence():
            ...
            K.assign(a_value, K.reinterpret("float32", gload_4[0]))
        ...
        def apply_z_gate(value, z_value):
            ...
            K.evaluate(K.ptx["mul.ftz.f32"](mul_0[0], sub_0[0], K.float32(_LOG2_E)))
            exp2_0 = K.alloc_local((1,), "float32")
            K.evaluate(K.ptx["ex2.approx.ftz.f32"](exp2_0[0], mul_0[0]))
            exp_neg_z: K.float32 = exp2_0[0]
            add_0 = K.alloc_local((1,), "float32")
            K.evaluate(K.ptx["add.ftz.f32"](add_0[0], K.float32(1.0), exp_neg_z))
            div_0 = K.alloc_local((1,), "float32")
            K.evaluate(K.ptx["div.approx.ftz.f32"](div_0[0], K.float32(1.0), add_0[0]))
            sigmoid_z: K.float32 = div_0[0]
            mul_1 = K.alloc_local((1,), "float32")
            K.evaluate(K.ptx["mul.ftz.f32"](mul_1[0], z_value, sigmoid_z))
            K.evaluate(K.ptx["mul.ftz.f32"](value, value, mul_1[0]))
        ...
        def update_sequence(IS_PAD: K.constexpr):
            ...
            with K.If(flat_tid < seq_len), K.Then():
                ...
                with K.If(dt_softplus != 0), K.Then():
                    with K.If(dt_value <= K.float32(20.0)), K.Then():
                        ...
                        K.evaluate(K.ptx["mul.ftz.f32"](mul_2[0], dt_value, K.float32(_LOG2_E)))
                        ...
                        K.evaluate(K.ptx["add.ftz.f32"](add_1[0], K.float32(1.0), dt_exp))
                        log2_0 = K.alloc_local((1,), "float32")
                        K.evaluate(K.ptx["lg2.approx.ftz.f32"](log2_0[0], add_1[0]))
            ...
            with K.If(flat_tid < NTOKENS), K.Then():
                ...
                K.evaluate(K.ptx.st.shared.b64(s_dst_slots.ptr_to([step]), dst_slot))
            ...
            with K.serial(NUM_PASSES) as pass_idx:
                ...
                if SCALE_STATE and not IS_PAD:
                    gload_5 = K.alloc_local((1,), "uint32")
                    K.evaluate(
                    ...
                    K.assign(decode_scale, K.reinterpret("float32", gload_5[0]))
                        ...
                        with K.Then():
                            ...
                            with K.unroll(PAIRS_PER_TILE_MEMBER) as pair_idx:
                                ...
                                if STATE_DTYPE == "bfloat16":
                                    ...
                                    f16_f32_1 = K.alloc_local((1,), "float32")
                                    K.evaluate(
                                        K.ptx.cvt.f32.f16(
                                            f16_f32_1[0],
                                            K.cast(
                                    ...
                                    K.assign(
                                        state_pair, K.cuda.make_float2(f16_f32_0[0], f16_f32_1[0])
                                    )
                                    ...
                                    i16_f32_1 = K.alloc_local((1,), "float32")
                                    K.evaluate(
                                        K.ptx.cvt.rn.f32.s16(
                                            i16_f32_1[0],
                                            K.reinterpret(
                                    ...
                                    K.assign(
                                        state_pair, K.cuda.make_float2(i16_f32_0[0], i16_f32_1[0])
                                    )
                                else:
                                    K.assign(
                                        state_pair,
                ...
                with K.serial(NTOKENS) as step:
                    with K.If(step < seq_len), K.Then():
                        dst_slot = K.local_scalar("int64")
                        K.evaluate(K.ptx.ld.shared.b64(dst_slot, s_dst_slots.ptr_to([step])))
                        dt_value = K.local_scalar("float32")
                        sload_0 = K.alloc_local((1,), "uint32")
                        K.evaluate(K.ptx.ld.shared.b32(sload_0[0], s_dt.ptr_to([dt_step])))
                        K.assign(dt_value, K.reinterpret("float32", sload_0[0]))
                        mul_3 = K.alloc_local((1,), "float32")
                        K.evaluate(K.ptx["mul.ftz.f32"](mul_3[0], a_value, dt_value))
                        mul_4 = K.alloc_local((1,), "float32")
                        K.evaluate(K.ptx["mul.ftz.f32"](mul_4[0], mul_3[0], K.float32(_LOG2_E)))
                        exp2_2 = K.alloc_local((1,), "float32")
                        K.evaluate(K.ptx["ex2.approx.ftz.f32"](exp2_2[0], mul_4[0]))
                        da_value: K.float32 = exp2_2[0]
                        sload_1 = K.alloc_local((1,), "uint16")
                        K.evaluate(
                            K.ptx.ld.shared.b16(sload_1[0], s_x.ptr_to([x_step + local_row]))
                        )
                        bf16_f32_1 = K.alloc_local((1,), "float32")
                        K.evaluate(K.ptx.cvt.f32.bf16(bf16_f32_1[0], K.cast(sload_1[0], "uint16")))
                        x_value: K.float32 = bf16_f32_1[0]
                        mul_5 = K.alloc_local((1,), "float32")
                        K.evaluate(K.ptx["mul.ftz.f32"](mul_5[0], dt_value, x_value))
                        dtx_value: K.float32 = mul_5[0]
                        ...
                        with K.If(member == 0), K.Then():
                            ...
                            K.evaluate(
                                K.ptx["fma.rn.ftz.f32"](fma_0[0], d_value, x_value, out_value)
                            )
                            row_output: K.float32 = fma_0[0]
                            K.evaluate(
                                K.ptx.st.shared.b32(
                                ...
                                with K.unroll(NUM_TILES) as tile_idx:
                                    with K.unroll(PAIRS_PER_TILE_MEMBER) as pair_idx:
                                        ...
                                        with K.If(col0 < DSTATE), K.Then():
                                            ...
                                            K.evaluate(
                                                K.ptx["abs.ftz.f32"](
                                                    abs_0[0], K.cuda.float2_x(state_pair)
                                                )
                                            )
                                            abs_1 = K.alloc_local((1,), "float32")
                                            K.evaluate(
                                                K.ptx["abs.ftz.f32"](
                                                    abs_1[0], K.cuda.float2_y(state_pair)
                                                )
                                            )
                                            max_0 = K.alloc_local((1,), "float32")
                                            K.evaluate(
                                                K.ptx["max.ftz.f32"](max_0[0], abs_0[0], abs_1[0])
                                            )
                                            max_1 = K.alloc_local((1,), "float32")
                                            K.evaluate(
                                                K.ptx["max.ftz.f32"](max_1[0], local_max, max_0[0])
                                            )
                                            K.assign(local_max, max_1[0])
                                with K.unroll(3) as delta_idx:
                                    delta: K.int32 = K.shift_right(K.int32(4), delta_idx)
                                    peer_max: K.float32 = K.cuda.__shfl_down_sync(
                                        K.uint32(0xFFFFFFFF), local_max, delta, 32
                                    )
                                    K.evaluate(K.ptx["max.ftz.f32"](local_max, local_max, peer_max))
                                ...
                                with K.If(member_col < DSTATE), K.Then():
                                    ...
                                    with K.unroll(PAIRS_PER_TILE_MEMBER) as pair_idx:
                                        ...
                                        if SCALE_STATE:
                                            ...
                                            K.evaluate(
                                                K.ptx["min.ftz.f32"](
                                                    min_0[0], max_2[0], K.float32(32767.0)
                                                )
                                            )
                                            low_scaled: K.float32 = min_0[0]
                                            max_3 = K.alloc_local((1,), "float32")
                                            K.evaluate(
                                                K.ptx["max.ftz.f32"](
                                                    max_3[0],
                                            ...
                                            min_1 = K.alloc_local((1,), "float32")
                                            K.evaluate(
                                                K.ptx["min.ftz.f32"](
                                                    min_1[0], max_3[0], K.float32(32767.0)
                                                )
                                            )
                                            high_scaled: K.float32 = min_1[0]
                                            low_i32 = K.alloc_local((1,), "int32")
                                            high_i32 = K.alloc_local((1,), "int32")
                                            K.evaluate(
                                                K.ptx.cvt.rni.ftz.s32.f32(low_i32[0], low_scaled)
                                            )
                                            K.evaluate(
                                                K.ptx.cvt.rni.ftz.s32.f32(high_i32[0], high_scaled)
                                            )
                                            ...
                                            K.evaluate(
                                                K.ptx["prmt.b32"](
                                                    ...
                                                    K.cast(
                                                        K.reinterpret("uint32", high_i32[0]),
                                                        "uint32",
                                                    ),
                                                    K.uint32(0x5410),
                                                )
                                            )
                                            K.ptx.mov.b32(store_words[pair_idx], prmt_0[0])
                                        elif PHILOX_ROUNDS > 0:
                                            element_idx: K.int32 = pair_idx * 2
                                            with K.If(pair_idx % 2 == 0), K.Then():
                                                offset_mad = K.alloc_local((1,), "int32")
                                                K.ptx.mad.lo.s32(
                                                    offset_mad[0],
                                                    row_d,
                                                    K.int32(DSTATE),
                                                ...
                                                K.evaluate(
                                                    K.ptx["add.s32"](
                                                        add_s32_0[0],
                                                        offset_mad[0],
                                                        member_col + element_idx,
                                                    )
                                                )
                                                random_offset: K.int32 = add_s32_0[0]
                                                c0 = K.local_scalar("uint32")
                                                K.assign(
                                                    c0, (K.reinterpret("uint32", random_offset))
                                                )
                                                c1_signed = K.alloc_local((1,), "int32")
                                                K.ptx.shr.s32(
                                                    c1_signed[0], random_offset, K.uint32(31)
                                                )
                                                c1 = K.local_scalar("uint32")
                                                K.assign(
                                                    c1, (K.reinterpret("uint32", c1_signed[0]))
                                                )
                                                ...
                                                K.assign(k0, K.cast(seed_u64, "uint32"))
                                                ...
                                                with K.unroll(10) as philox_round:
                                                    ...
                                                    next_c0: K.uint32 = K.bitwise_xor(
                                                        K.bitwise_xor(mul_hi_0[0], c1), k0
                                                    )
                                                    ...
                                                    next_c2: K.uint32 = K.bitwise_xor(
                                                        K.bitwise_xor(mul_hi_1[0], c3), k1
                                                    )
                                                    ...
                                                    next_k0: K.int32 = add_s32_1[0]
                                                    add_s32_2 = K.alloc_local((1,), "int32")
                                                    K.evaluate(
                                                        K.ptx["add.s32"](
                                                            add_s32_2[0],
                                            ...
                                            packed_f16 = K.alloc_local((1,), "uint32")
                                            K.evaluate(
                                            ...
                                            K.ptx.mov.b32(store_words[pair_idx], (packed_f16[0]))
                                        elif STATE_DTYPE == "bfloat16":
                                            low_bits = K.local_scalar("uint16")
                                            f32_bf16_0 = K.alloc_local((1,), "uint16")
                                            K.evaluate(
                                                K.ptx.cvt.rn.bf16.f32(
                                                    f32_bf16_0[0], K.cuda.float2_x(state_pair)
                                                )
                                            )
                                            K.assign(low_bits, (f32_bf16_0[0]))
                                            high_bits = K.local_scalar("uint16")
                                            f32_bf16_1 = K.alloc_local((1,), "uint16")
                                            K.evaluate(
                                                K.ptx.cvt.rn.bf16.f32(
                                                    f32_bf16_1[0], K.cuda.float2_y(state_pair)
                                                )
                                            )
                                            K.assign(high_bits, (f32_bf16_1[0]))
                                            K.evaluate(
                                                K.ptx.mov.b32(
                ...
                with K.If(step < seq_len), K.Then():
                    ...
                    if DIM_PER_CTA >= 32:
                        ...
                        if DIM_PER_CTA == 32:
                            ...
                            K.evaluate(
                                K.ptx.ld.shared.b32(
                                    sload_2[0], s_out.ptr_to([step * DIM_PER_CTA + local_col])
                                )
                            )
                            K.ptx.mov.b32(out_words[0], sload_2[0])
                        elif DIM_PER_CTA == 64:
                            if OUT_ALIGNED:
                                K.evaluate(
                                    K.ptx.ld.shared.v2.b32(
                                ...
                                sload_3 = K.alloc_local((1,), "uint32")
                                K.evaluate(
                                    K.ptx.ld.shared.b32(
                                        sload_3[0], s_out.ptr_to([step * DIM_PER_CTA + local_col])
                                    )
                                )
                                K.ptx.mov.b32(out_words[0], sload_3[0])
                                sload_4 = K.alloc_local((1,), "uint32")
                                K.evaluate(
                                    K.ptx.ld.shared.b32(
                                        sload_4[0],
                                        s_out.ptr_to([step * DIM_PER_CTA + local_col + 1]),
                                    )
                                )
                                K.ptx.mov.b32(out_words[1], sload_4[0])
                        else:
                            K.evaluate(
                                K.ptx.ld.shared.v4.b32(
                                    out_words[0],
                        ...
                        with K.unroll(DIM_PER_CTA // 32) as element:
                            ...
                            if HAS_Z:
                                ...
                                K.evaluate(
                                    K.ptx.cvt.f32.bf16(
                                        bf16_f32_2[0], K.cast(z_bits[element], "uint16")
                                    )
                                )
                                z_value: K.float32 = bf16_f32_2[0]
                                apply_z_gate(value, z_value)
                            K.evaluate(K.ptx.cvt.rn.bf16.f32(output_bits[element], value))
                        if DIM_PER_CTA == 32:
                            K.evaluate(
                        ...
                        with K.If(lane < DIM_PER_CTA), K.Then():
                            ...
                            K.evaluate(
                                K.ptx.ld.shared.b32(
                                    sload_5[0], s_out.ptr_to([step * DIM_PER_CTA + lane])
                                )
                            )
                            K.assign(value, K.reinterpret("float32", sload_5[0]))
                            if HAS_Z:
                                gload_6 = K.alloc_local((1,), "uint16")
                                K.evaluate(
                                    K.ptx.ld.global_.b16(gload_6[0], z.ptr_to([z_base + lane]))
                                )
                                bf16_f32_3 = K.alloc_local((1,), "float32")
                                K.evaluate(
                                    K.ptx.cvt.f32.bf16(bf16_f32_3[0], K.cast(gload_6[0], "uint16"))
                                )
                                z_value: K.float32 = bf16_f32_3[0]
                                apply_z_gate(value, z_value)
                            f32_bf16_2 = K.alloc_local((1,), "uint16")
                            K.evaluate(K.ptx.cvt.rn.bf16.f32(f32_bf16_2[0], value))
                            output_bit: K.uint16 = f32_bf16_2[0]
                            K.evaluate(
