...
from tirx_kernels.flashmla import sparse_prefill_head64_phase1
from tirx_kernels.low_level_ir import check_low_level_ir
from tvm import tirx


@pytest.mark.parametrize(
    "config", sparse_prefill_head64_phase1.CONFIGS, ids=lambda config: config["label"]
)
def test_public_phase1_kernel_satisfies_the_low_level_launch_and_abi_contract(
    ...
    kernel = sparse_prefill_head64_phase1.get_kernel(**parameters)
